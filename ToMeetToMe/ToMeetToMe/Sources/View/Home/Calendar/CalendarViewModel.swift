...
class CalendarViewModel: ObservableObject {
    ...
    init(
        ...
        Schedule(name: "어렵다", startAt: "2024-01-04T19:11:00", endAt: "2023-12-04T19:11:00", allDay: true, memo: "오늘 저녁은 고기!", notification: true, repeatString: "repeat process", complete: false)
        ]
    ) {
